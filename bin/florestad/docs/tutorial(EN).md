...
Once you have the Extended Public Key in hand, copy the configuration file `contrib/config.toml.sample` to `config.toml` and edit it by inserting the xpub in the appropriate field. You can insert infinite xpubs. Loose addresses are also allowed.
